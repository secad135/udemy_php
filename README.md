...
4. Object Initialisation the Constructor Method
 - تابع کنستراکت برای مقداردهی اولیه
 - این تابع هنگام ساخت یک شی جدید به صورت اتوماتیک فراخوانی میشود
 - دو آندرلاین در اسم این تابع الزامی است

5. Control Access Public and Private visibility of Properties and Methods
 - دسترسی پذیری و قابل رویت بودن را می توان با کلمات کلیدی پیشوند ویژگی ها و متدها استفاده کرد
 - متدها به صورت پیشفرض عمومی هستند اما بهتر است کلمه آن مشخص شود تا بعدا به مشکل نخوریم

6. Public Properties vs Getter and Setter Methods
 - برای وقتی که نیاز داریم نوع داده شی هایی که ساخته میشود را مدیریت کنیم
 - دو تابع گتر و ستر را بکار میبریم اول باید پراپرتی ها خصوصی باشند
 - با این روش در حین ساخت شی ها به صورت مستقیم به پراپرتی آنها دسترسی نداریم و میتوان مدیریت بهتری ایجاد کرد.
 - می توان با این روش یک پراپرتی را فقط خواندنی یا فقط نوشتی کرد
 - چون برای هر پراپرتی باید دو تابع نوشت و توسعه کدها کمی پیچیده تر و حجم کدها بیشتر می شود الزامی نیست از این توابع استفاده شود

7. Static Properties and Methods
 - مهم‌ترین کاربردهای static در پروژه‌های واقعی PHP عبارت‌اند از:
    - شمارنده‌ها و داده‌های مشترک بین همه اشیاء
...
8. Constants Using Define and const to Create Constant Values
 - ثابت ها در کلاس با کلمه کلیدی 'CONST' تعریف میشوند

9. Inheritance Using the Extends Keyword to reuse Code and reduce Repetition
 - وراثت در کلاس ها. با کلمه کلیدی extends بعد از نام کلاس فرزند که نام کلاس والد میآید
 - وراثت باعث میشود متدها و پراپرتی های والد به فرزند ارث برسد و از تکرار کدها جلوگیری شود

10. Overriding Methods and Using the Parent Keyword to Call the Parent Class Code
 - میتوان کلاس فرزند را در متدهایش به صورت ویرایش شده نسبت به والدش داشته باشیم و با استفاده از کلمه کلیدی 'parent::' میتوان تغییراتی که در کد والد ایجاد میشود را در کد فرزند هم به صورت اتوماتیک داشته باشیم

11. Control Access Protected Visibility of Properties and Methods
 - حالت محافظت شده برای پراپرتی ها و متدها از بیرون کلاس قابل دسترسی نیستند اما کلاس های فرزند میتوانند از آنها استفاده کنند
 - این قابلیت برای خصوصی کار نمیکند. کلاس فرزند نمی تواند به متد یا پراپرتی خصوصی والد دسترسی داشته باشد.
